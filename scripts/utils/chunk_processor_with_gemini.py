...
#         {
#             "role": "user",
#             "content": f"Refine this text while maintaining its original paragraph structure. Only reply the refined text:\n\n{chunk}",
#         }
#     ]
...
#             # Take a 1-minute break after every 10 chunks
#             if processed_chunks_count % 10 == 0:
